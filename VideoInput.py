...
exercise=input("Specify the exercise to be predicted: ")

cap = cv2.VideoCapture('ExerciseVideos/'+exercise+'.mov')
...
loaded_model = keras.models.load_model('GymPose_Model')
